...
function mTheme_admin_menu_scripts($hook) {
	...
	if (function_exists('add_thickbox'))
		...
		wp_enqueue_script('mTheme-admin-menu-js', mTheme_URL .'assets/js/admin-menu.js', array('common', 'jquery', 'media-upload', 'thickbox'), false, '1.0');
}
...
function mTheme_menu_item( $walker ) {
	...
	if ( ! class_exists( $walker ) ) {
		require_once plugin_dir_path( __FILE__ ) . 'menu-item.php';
	}
